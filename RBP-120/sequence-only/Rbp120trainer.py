...
result_path = 'RBP-120/sequence-only/results/'
...
class RbpTrainer():
    ...
    def __init__(self, model_dir):
        self.logfile = open(result_path+time.strftime("%m-%d-%H", time.localtime())+'rbp120.txt','w')
...
if __name__=='__main__':
    name_list = glob('RBP-120/sequence-only/sample/*')
    trainer = RbpTrainer('RBP-120/sequence-only/models/')
