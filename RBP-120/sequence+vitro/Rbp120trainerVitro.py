...
result_path = 'RBP-120/sequence+vitro/results/'
...
class RbpTrainer():
    ...
    def __init__(self, model_dir):
        self.logfile = open(result_path+time.strftime("%m-%d-%H", time.localtime())+'rbp120Vitro.txt','w')
...
if __name__=='__main__':
    name_list = glob('RBP-120/sequence+vitro/sample/*')
    trainer = RbpTrainer('RBP-120/sequence+vitro/models/')
